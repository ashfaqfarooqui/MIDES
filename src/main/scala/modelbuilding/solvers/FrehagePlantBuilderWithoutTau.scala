...
import modelbuilding.solvers.FrehagePlantBuilderWithoutTau._

import scala.collection.mutable

object FrehagePlantBuilderWithoutTau {
 ...
 */
class FrehagePlantBuilderWithoutTau(_sul: SUL) extends BaseSolver {
